      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="modal-section">
            ...
            <div className="modal-info-grid">
              ...
              <div>
                ...
                <span className="value">{order.customer_info?.phone}</span>
              </div>
              <div>
                <span className="label">Email:</span>{" "}
                <span className="value">{order.customer_info?.email}</span>
              </div>
            </div>
          </div>
          ...
          <div className="modal-section">
            ...
            <div className="modal-info-grid">
              ...
              <div>
                ...
                <span className="value">{order.shipping_address?.city}</span>
              </div>
              <div>
              ...
              <div>
                <span className="label">Doorbell:</span>{" "}
                <span className="value">
              ...
              {order.shipping_address?.notes && (
                <div className="full-width">
                  ...
                  <span className="value notes-text">
                    {order.shipping_address?.notes}
                  </span>
                </div>
              )}
          ...
          <div className="modal-totals">
            ...
            <div className="total-row">
              <span>Floor Fee</span>
              <span>${order.floor_fee?.toFixed(2)}</span>
            </div>
            <div className="total-row">
              <span>Tax</span>
